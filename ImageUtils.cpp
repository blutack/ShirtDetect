...
{
	if (image_tile)
		std::cout << "Image: " << image_tile->width << "x" << image_tile->height << "px, " << image_tile->nChannels << "channels of " << image_tile->depth << "bit depth, widthStep=" << image_tile->widthStep << endl;
	else
